...
Codex and other coding agents may plan, edit, test, and document code directly
in this repository. There is no special planner/executor split between agents.
Follow the same engineering rules as any coding agent working here.
