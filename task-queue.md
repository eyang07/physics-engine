...
1. **FE-060: ObligationList with progressive disclosure**
...
2. **FE-061: ArtifactPanel — IR / package export**
...
3. **FE-062: DocketRail — verification problem list**
...
4. **FE-063: Apply the light-technical visual language and token deltas (drop serif)**
...
5. **FE-064: Replace the four legend overlays with one compact legend and selection linking**
...
6. **FE-065: Move playback and full detail into a collapsible bottom strip**
...
7. **FE-066: Document the verification UI shell and refresh its visual baselines**
