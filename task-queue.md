...
1. **BE-100: Geodesics on surfaces of revolution**
...
2. **BE-101: Surface-embedding and geodesic export schema with renderer hints**
...
3. **BE-102: Effective-potential and orbit classification for central-force and GR orbits**
...
4. **BE-103: Full Schwarzschild geodesics (timelike and null)**
...
5. **BE-104: Parallel transport and holonomy on curved surfaces**
...
6. **BE-105: Curvature scalar fields and a Gauss–Bonnet diagnostic**
...
7. **BE-106: Add a second curved background (wormhole or FLRW)**
...
8. **BE-079: Cross-check reachability handoff coverage against certified coverage**
...
9. **BE-080: Add a reachability handoff dependency index**
