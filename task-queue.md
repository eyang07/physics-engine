...
1. **BE-122: Add the uniform-proper-acceleration (hyperbolic motion) system**
...
2. **BE-123: Add a relativistic particle in a static potential**
...
3. **BE-124: Wire four-momentum conservation and mass-shell into verification export**
...
4. **BE-125: Add the Faraday field tensor and its invariants**
...
5. **BE-126: Add the electromagnetic four-potential and gauge transform**
...
6. **BE-127: Add the covariant Lorentz force as a first-order system**
...
7. **BE-128: Add the relativistic cyclotron system (uniform B)**
...
8. **BE-129: Add the crossed-field E x B drift system**
...
9. **BE-130: Add the general relativistic charged-particle system**
...
10. **BE-131: Add Maxwell-source constraint diagnostics and EM-invariant obligations**
...
11. **BE-132: Add a Lagrangian field-density object with symbolic Euler-Lagrange**
...
12. **BE-133: Add symbolic stress-energy and a measured conservation residual**
...
13. **BE-134: Add the scalar field-density example and export**
...
14. **BE-135: (UNSCHEDULED, gated) Sketch a finite-dimensional Hilbert / spin-precession toy**
