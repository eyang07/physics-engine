...
1. **BE-128: Add the relativistic cyclotron system (uniform B)**
...
2. **BE-129: Add the crossed-field E x B drift system**
...
3. **BE-130: Add the general relativistic charged-particle system**
...
4. **BE-131: Add Maxwell-source constraint diagnostics and EM-invariant obligations**
...
5. **BE-132: Add a Lagrangian field-density object with symbolic Euler-Lagrange**
...
6. **BE-133: Add symbolic stress-energy and a measured conservation residual**
...
7. **BE-134: Add the scalar field-density example and export**
...
8. **BE-135: (UNSCHEDULED, gated) Sketch a finite-dimensional Hilbert / spin-precession toy**
